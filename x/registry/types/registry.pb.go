...
type Proposal struct {
	...
	// uploader ...
	Uploader string `protobuf:"bytes,3,opt,name=uploader,proto3" json:"uploader,omitempty"` // Deprecated: Do not use.
	// from_height ...
	FromHeight uint64 `protobuf:"varint,4,opt,name=from_height,json=fromHeight,proto3" json:"from_height,omitempty"` // Deprecated: Do not use.
	// to_height ...
	ToHeight uint64 `protobuf:"varint,5,opt,name=to_height,json=toHeight,proto3" json:"to_height,omitempty"` // Deprecated: Do not use.
	// finalized_at ...
	FinalizedAt uint64 `protobuf:"varint,6,opt,name=finalized_at,json=finalizedAt,proto3" json:"finalized_at,omitempty"` // Deprecated: Do not use.
	// bundle ...
	Bundle uint64 `protobuf:"varint,7,opt,name=bundle,proto3" json:"bundle,omitempty"`
	// to_key ...
...
func (m *Proposal) GetBundle() uint64 {
	if m != nil {
		return m.Bundle
	}
	return 0
...
func (m *Proposal) GetToKey() string {
	if m != nil {
		return m.ToKey
	}
	return ""
...
func (m *Proposal) GetToValue() string {
	if m != nil {
		return m.ToValue
	}
	return ""
...
var fileDescriptor_db13ea1584a90e6e = []byte{
	...
	,
}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Bundle != 0 {
		i = encodeVarintRegistry(dAtA, i, uint64(m.Bundle))
		i--
		dAtA[i] = 0x38
	}
	if m.FinalizedAt != 0 {
...
func (m *Proposal) Size() (n int) {
	...
	if m.Bundle != 0 {
		n += 1 + sovRegistry(uint64(m.Bundle))
	}
	l = len(m.ToKey)
	if l > 0 {
		n += 1 + l + sovRegistry(uint64(l))
